    ...
    <div class="all_media">
		...
		<div class="media_box">
			<?php
				...
				{
					echo "<img src='".$filepath.$filename."' height=200 width=300 border = 5/>";
				}
				else //view movie
				{
			?>
		    <object id="MediaPlayer" width=300 height=200 classid="CLSID:22D6f312-B0F6-11D0-94AB-0080C74C7E95" standby="Loading Windows Media Player components…" type="application/x-oleobject" codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=6,4,7,1112" border = 5>
